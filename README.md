<p align="center"><img src="https://github.com/wholder/TeensyCNC2/blob/master/images/cricutmini.jpg" width="75%" height=75%"></p>
...
Note 1: Because it's now orphaned by Provo Craft, I was able to purchase a used Cricut Mini on Craigslist for $30.  They are usually quite a few of them available on eBay, but often for ridiculously high prices, as sellers don't seem to have caught on that the Mini is now, effectively useless.  So, you made need to be patient to find one selling for a reasonable price.  If you're lucky, you might also find a used Mini at local swap meets and garage sales, or even at a thrift store.  If you find one missing its power supply, you can substitute an 18 Volt DC laptop power supply that can supply at least 1.8 Amps and has a center positive, 5.5 mm OD, 2.5 mm ID Barrel Jack.  You may also find these in surplus, or thrift stores, or ebay.  If you intend to use your Mini to cut materials, look for one that comes with the Adjustable Blade Holder.
...
<p align="center"><img src="https://github.com/wholder/TeensyCNC2/blob/master/images/mechanical.jpg" width="75%" height=75%"></p>
 ...
 2. Unsolder and remove the 14 pin and 28 pin "PIC" microprocessors from the PCB.  [Click here](images/removethese.jpg) to see where these are located on the PCB.  This is probably the trickiest part of the conversion, as it normally easiest to use a heat gun to remove surfac emount part.  However, if you are careful, you can use small diagonal cutters to clip each pin of the IC package to remove the IC and then use a soldering iron to unsolder and remove the leftover pins one by one.  However, be careful not to damage or nick the delicate traces on the PCB.  Alternatively, you might also try [the technique shown in this YouTube video](https://www.youtube.com/watch?v=CVsmwFAkf7I).
 ...
 <p align="center"><img src="https://github.com/wholder/TeensyCNC2/blob/master/images/LaserCut.png" width="75%" height=75%"></p>
...
Start by covering all the edges of the cutting mat with Blue Painter's Tape.  The tape should be used to mask off the 1/2 inch areas on boft the left and right sides of the mat where the feed rollers engage as well as the 1 inch areas at the top and bottom of the mat, which are outside the area where the Mini typically cuts, or draws.  This should leave an unmasked area 8.5 x 12 inches in size. Wrap any excess tape around to the backside of the mat.  Once the edges are masked, place the masked mat onto a sheet of newspaper and carefully spray the unmasked area of the cutting mat with the Krylon K07020007 Easy Tack Repositionable Adhesive Spray.  Then, once the Krylon spray has dried ([3 hours according to the manufacturer](https://www.krylon.com/products/easytack-repositionable-adhesive/)), test the stickiness of the surface by applying some the material you intend to use in the Mini.  Remove the tape when you're satisfied with the stickiness and try out your newly-made cutting mat in the Mini.  When not in use, cover and protect the tacky surface of the mat using a sheet of the Grafix Dura-Lar film, or some other, similar material.
